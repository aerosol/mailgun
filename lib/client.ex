defmodule Mailgun.Client do
  ...
  def get_attachment(conf \\ Application.get_all_env(:mailgun), url) do
    request conf, :get, url, "api", conf[:key], [], "", ""
  end

  def send_email(conf \\ Application.get_all_env(:mailgun), email) do
    case conf[:mode] do
      :test ->
